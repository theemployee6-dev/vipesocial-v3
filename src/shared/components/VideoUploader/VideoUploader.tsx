  ...
  return (
    <div
      ...
      className={`
        ...
        ${
          isDragging
            ? "border-[#FE2C55] bg-[rgba(254,44,85,0.08)]"
            : "border-white/10 bg-[#1C1B1B] hover:border-white/20"
        }
      `}
    >
      <input
      ...
      <div className="flex flex-col items-center justify-center py-12 px-6 text-center">
        {!isUploading && !fileName && (
          <>
            {/* Ícone de vídeo com nova cor */}
            <div className="w-14 h-14 rounded-2xl bg-[rgba(254,44,85,0.1)] border border-[rgba(254,44,85,0.2)] flex items-center justify-center mb-4">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path
                  d="M15 10l4.553-2.276A1 1 0 0121 8.723v6.554a1 1 0 01-1.447.894L15 14M3 8a2 2 0 012-2h8a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8z"
                  stroke="#FE2C55"
            ...
            <p className="font-syne text-base font-semibold text-white mb-1">
              Arraste seu vídeo aqui
            </p>
            <p className="font-dm-sans text-sm text-[#E6BCBD] mb-4">
              ou clique para selecionar
            </p>
            <div className="inline-flex items-center gap-1.5 rounded-full px-3 py-1 bg-[rgba(254,44,85,0.08)] border border-[rgba(254,44,85,0.15)]">
        ...
        {isUploading && (
          <>
            ...
            {/* Barra de progresso com nova cor */}
            ...
            <p className="font-dm-sans text-xs text-[#888888] mt-2">
              {uploadProgress}%
            </p>
          </>
        )}
        ...
        {!isUploading && fileName && uploadProgress === 100 && (
          <>
            ...
            <p className="font-dm-sans text-sm text-[#E6BCBD]">{fileName}</p>
          </>
        )}
      </div>
    </div>
