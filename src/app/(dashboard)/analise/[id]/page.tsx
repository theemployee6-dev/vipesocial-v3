...
export default function AnalisePage() {
  ...
  return (
    <div className="min-h-screen bg-[#131313] flex flex-col items-center justify-center px-4 py-8 sm:px-6 sm:py-12">
      ...
      <div
        className="fixed w-[300] h-[300] sm:w-[400] md:w-[500] rounded-full top-[-50] left-1/2 -translate-x-1/2 pointer-events-none"
        style={{
          background:
            "radial-gradient(circle, rgba(254,44,85,0.12) 0%, rgba(254,44,85,0.04) 40%, transparent 70%)",
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          <span className="font-syne text-xl font-extrabold text-white">
            vipe<span className="text-[#FE2C55]">Social</span>
          </span>
        </div>
